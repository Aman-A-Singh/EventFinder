package com.ticket.master.eventfinder.utility
...
fun TextView.setResizableText(
    ...
    var charactersToTake = charactersAtLineEnd - suffixText.length // Good enough first guess
